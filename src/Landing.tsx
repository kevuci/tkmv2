...
const Landing: React.FC = () => {
  return (
    <motion.div
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1523991600108-3b5858570d19?q=80&w=3542&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
    ...
    >
      ...
      <motion.div
        className="absolute top-8 left-8 w-12 h-12 rounded-full bg-purple-200 opacity-70"
        initial={{ scale: 0 }}
        animate={{ scale: 1.2 }}
        transition={{
          repeat: Infinity,
      ...
      />
      <motion.div
        className="absolute bottom-8 right-8 w-12 h-12 rounded-full bg-purple-300 opacity-70"
        initial={{ scale: 0 }}
        animate={{ scale: 1.2 }}
        transition={{
          repeat: Infinity,
